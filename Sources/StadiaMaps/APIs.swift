...
// We reverted the change of StadiaMapsAPI to StadiaMaps introduced in https://github.com/OpenAPITools/openapi-generator/pull/9624
...
@available(*, deprecated, renamed: "StadiaMapsAPI")
public typealias StadiaMaps = StadiaMapsAPI

open class StadiaMapsAPI {
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool) {
        ...
        addHeaders(StadiaMapsAPI.customHeaders)
    }
    ...
    open func addCredential() -> Self {
        credential = StadiaMapsAPI.credential
        return self
    }
}

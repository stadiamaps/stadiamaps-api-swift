...
public struct GeocodingGeoJSONFeature: Codable, JSONEncodable, Hashable {
    ...
    public var properties: GeocodingGeoJSONProperties?
    /** An array of 4 floating point numbers representing the (W, S, E, N) extremes of the features found. */
    public var bbox: [Double]?

    public init(type: ModelType, geometry: GeoJSONPoint, properties: GeocodingGeoJSONProperties? = nil, bbox: [Double]? = nil) {
        self.type = type

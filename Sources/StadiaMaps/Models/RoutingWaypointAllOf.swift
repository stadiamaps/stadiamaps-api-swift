...
public struct RoutingWaypointAllOf: Codable, JSONEncodable, Hashable {
    ...
    public init(heading: Int? = nil, headingTolerance: Int? = 60, minimumReachability: Int? = 50, radius: Int? = 0, rankCandidates: Bool? = true, preferredSide: PreferredSide? = nil, nodeSnapTolerance: Int? = 5, streetSideTolerance: Int? = 5, streetSideMaxDistance: Int? = 1000, searchFilter: RoutingWaypointAllOfSearchFilter? = nil) {

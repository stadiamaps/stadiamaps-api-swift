...
class IntegrationXCTestCase: XCTestCase {
    override func setUpWithError() throws {
        let apiKey = ProcessInfo.processInfo.environment["STADIA_API_KEY"]
        try XCTSkipIf(apiKey == nil, "Skipping integration tests; missing STADIA_API_KEY environment variable")
